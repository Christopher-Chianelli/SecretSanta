...
import org.optaweb.secretsanta.domain.TimeTableView;
import org.optaweb.secretsanta.persistence.TimeTableRepository;
...
public class TimeTableSolverService {
    ...
    public TimeTableView getTimeTableView() {
        SecretSantaResult timeTable = timeTableRepository.findById(TimeTableRepository.SINGLETON_TIME_TABLE_ID);
