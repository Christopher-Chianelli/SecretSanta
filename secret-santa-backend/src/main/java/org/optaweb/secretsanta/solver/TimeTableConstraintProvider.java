...
public class TimeTableConstraintProvider implements ConstraintProvider {
    ...
    private Constraint roomConflict(ConstraintFactory constraintFactory) {
        return constraintFactory
                .fromUniquePair(SecretSantaAssignment.class,
                        Joiners.equal(SecretSantaAssignment::getTimeslot),
                        Joiners.equal(SecretSantaAssignment::getRoom))
    ...
    private Constraint teacherConflict(ConstraintFactory constraintFactory) {
        return constraintFactory
                .fromUniquePair(SecretSantaAssignment.class,
                        Joiners.equal(SecretSantaAssignment::getTimeslot),
                        Joiners.equal(SecretSantaAssignment::getTeacher))
    ...
    private Constraint studentGroupConflict(ConstraintFactory constraintFactory) {
        return constraintFactory
                .fromUniquePair(SecretSantaAssignment.class,
                        Joiners.equal(SecretSantaAssignment::getTimeslot),
                        Joiners.equal(SecretSantaAssignment::getStudentGroup))
    ...
    private Constraint teacherTimeEfficiency(ConstraintFactory constraintFactory) {
        return constraintFactory
                ...
                .join(SecretSantaAssignment.class, Joiners.equal(SecretSantaAssignment::getTeacher))
